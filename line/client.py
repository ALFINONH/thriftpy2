...
class LineClient(object):
    ...
    def __init__(self):
        ...
        self.transport = THttpClient("https://legy-jp-addr-long.line.naver.jp:443")
        self.transport.setCustomHeaders({
            "User-Agent": "Line/10.3.0 iPad5,1 10.2.0",
            "X-Line-Application": "IOSIPAD\t10.3.0\tiPhone OS\t10.12.0",
            "X-LHM": "POST",
            "X-lal": "ja-JP_JP"
        })
    ...
    def qr_login(self):
        ...
        qrcode = self.client.getAuthQrcode(keepLoggedIn=1, systemName='Line-Unofficial')
        ...
        getAccessKey = json.loads(self._session.get("https://legy-jp-addr-long.line.naver.jp/Q", headers=header).text)
...
class LEGY_ENDPOINT(object):
    ...
    UA = "Line/10.3.0 iPad5,1 10.2.0"
    LA = "IOSIPAD\t10.3.0\tiPhone OS\t10.12.0"
